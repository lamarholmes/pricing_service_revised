...
@dataclass(eq=False)  # Remove comparison
class Alert(Model):
    ...
    def notify_if_price_reached(self):
        if self.item.price < self.price_limit:
            ...
            Mailgun.send_mail(
                ...
                f'<p>Your alert {self.name} has reached a price under {self.price_limit}.</p><p>The latest is {self.item.price}.</p><p>Click <a href="{self.item.url}">here</a> to purchase your item.</p>'
            )
